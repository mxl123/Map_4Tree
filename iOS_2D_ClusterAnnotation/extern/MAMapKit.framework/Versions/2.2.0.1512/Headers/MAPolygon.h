...
/*!
 ...
 @return 新生成的多边形
 */
+ (MAPolygon *)polygonWithPoints:(MAMapPoint *)points count:(NSUInteger)count interiorPolygons:(NSArray *)interiorPolygons;
...
/*!
 ...
 @return 新生成的多边形
 */
+ (MAPolygon *)polygonWithCoordinates:(CLLocationCoordinate2D *)coords count:(NSUInteger)count interiorPolygons:(NSArray *)interiorPolygons;
