...
//  MAMapKit
//
//  Created by xiaoming han on 13-12-3.
...
extern "C" {
    ...
    /**
     *@brief 比例关系:MAZoomScale = Screen Point / MAMapPoint
     *@brief 当MAZoomScale = 1时, 1 screen point = 1 MAMapPoint. 
     *@brief 当MAZoomScale = 0.5时, 1 screen point = 2 MAMapPoints
     */
